    ...
    Public Class ViewModel
        ...
        Public Property MasterSource As Object
            ...
            Private Set(ByVal value As Object)
                If _masterSource Is value Then Return
                _masterSource = value
        ...
        Public Property DetailSource As Object
            ...
            Private Set(ByVal value As Object)
                If _detailSource Is value Then Return
                _detailSource = value
        ...
        Public Property CurrentRow As DataRowView
            ...
            Set(ByVal value As DataRowView)
                If _currentRow Is value Then Return
                _currentRow = value
        ...
        Private Function CreateData() As DataSet
            ...
            Dim ds As DataSet = New DataSet("CM")
            ds.Tables.Add(mdt)
            ds.Tables.Add(ddt)
        ...
        Private Sub UpdateDetailSource()
            Dim dv As DataView = New DataView(DataSet.Tables("Models"))
